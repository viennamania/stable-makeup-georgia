        ...
        <div className="py-0 w-full">
              ...
              {fetchingAllStores ? (
                ...
                <div className="flex flex-row items-center gap-2">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      router.push('/' + params.lang + '/agent/' + params.agentcode + '/buyorder?storecode=' + e.target.value);
                    }}
          ...
          <div className="mt-4 flex flex-row items-center justify-center gap-4">
            ...
            <div className="flex flex-row items-center gap-2">
              <select
                ...
                onChange={(e) =>
                  ...
                  router.push(`/${params.lang}/agent/${params.agentcode}/buyorder?storecode=${searchStorecode}&limit=${e.target.value}&page=1`)
                }
            ...
            <button
              ...
              onClick={() => {
                router.push(`/${params.lang}/agent/${params.agentcode}/buyorder?storecode=${searchStorecode}&limit=${Number(limit)}&page=1`)
              }}
            >
              처음으로
            </button>
            ...
            <button
              ...
              onClick={() => {
                ...
                router.push(`/${params.lang}/agent/${params.agentcode}/buyorder?storecode=${searchStorecode}&limit=${Number(limit)}&page=${Number(page) - 1}`)
            ...
            <button
              ...
              onClick={() => {
                ...
                router.push(`/${params.lang}/agent/${params.agentcode}/buyorder?storecode=${searchStorecode}&limit=${Number(limit)}&page=${Math.ceil(Number(totalCount) / Number(limit))}`)
