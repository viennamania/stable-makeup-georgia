                ...
                >
                  <tr>
                    ...
                    <th className="p-2">
                      <div className="
                        w-40 sm:w-64
                        flex flex-col sm:flex-row items-between justify-between gap-2">
                        <span className="sm:w-1/2 text-left">
                          회원 아이디
                        </span>
                        <span>가맹점 </span>
                      </div>
          ...
          <div className="mt-4 flex flex-row items-center justify-center gap-4">
            ...
            <div className="flex flex-row items-center gap-2">
                <select
                  ...
                  onChange={(e) =>
                    ...
                    router.push(`/${params.lang}/agent/${params.agentcode}/member?limit=${e.target.value}&page=1`)
            ...
            <button
              ...
              onClick={() => {
                ...
                router.push(`/${params.lang}/agent/${params.agentcode}/member?limit=${Number(limit)}&page=${Number(page) - 1}`);
