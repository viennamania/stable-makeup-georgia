              ...
              ">
                ...
                {true && (
                  ...
                  <div className="w-full flex flex-col gap-3 justify-start items-start mt-5">
                    ...
                    <button
                      onClick={() => {
                        const url = `/${params.lang}/admin/bank-deposited`;
                        window.open(url, "_blank", "noopener,noreferrer");
                      }}
                      className="w-full bg-blue-700 text-sm text-white px-4 py-2 rounded-lg hover:bg-blue-600"
                    >
                      은행 입금 로그
                    </button>
                    <button
                    ...
                    <button
                      onClick={() => {
                        const url = `/${params.lang}/admin/banktransfer-log`;
                        window.open(url, "_blank", "noopener,noreferrer");
                      }}
                    ...
                    <button
                      ...
                      className="w-full bg-amber-700 text-sm text-white px-4 py-2 rounded-lg hover:bg-amber-600"
                    >
                      공개 회원생성 API 호출 로그
                    </button>
                    <button
                      ...
                      className="w-full bg-cyan-700 text-sm text-white px-4 py-2 rounded-lg hover:bg-cyan-600"
                    >
                      Admin 권한 API 호출 로그
                    </button>
                    <button
