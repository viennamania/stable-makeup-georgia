...
export default function StoreSettingsLogPage() {
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      toast.error("Store Settings API 로그 조회에 실패했습니다.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 bg-gradient-to-r from-zinc-900 via-slate-800 to-zinc-900 text-white rounded-2xl p-4 shadow-lg shadow-zinc-900/40">
          <div>
            ...
            <div className="text-xl font-bold">Store Settings API 호출 이력</div>
            <div className="text-xs text-slate-300 mt-1">collection: storeSettingsApiCallLogs</div>
          </div>
