          ...
          w-full flex flex-col justify-between items-center gap-2">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                window.location.assign("/" + lang + "/" + params.center + "/center");
              }}
            >
              <option value="en">
                English(US)
          ...
          <div className="p-6 w-full flex flex-col items-start justify-center gap-2">
            ...
            <div className="w-full flex justify-start items-center gap-2">
                ...
                */}
                ...
                <div className="mt-5 w-full flex flex-col sm:flex-row items-center justify-end gap-2">
                ...
                f<        className="w-full p-2 border border-zinc-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3167b4]"
                      >
                  ...
                  */}
                  ...
                  {true && (
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-2">
                      ...
                      {/* divider */}
                      {/*
                      <div className="sm:hidden w-full h-0.5 bg-zinc-200 my-2" />
                ...
                */}
                ...
                {address && !user?.seller?.bankInfo && (
                  <div className="flex flex-col sm:flex-row items-center gap-2 mt-4 mb-4">
                    <Image
                      src="/icon-bank.png"
                      alt="Bank"
                      width={35}
