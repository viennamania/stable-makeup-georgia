          ...
          */}
          ...
          <select
            ...
            onChange={(e) => {
              ...
              window.location.assign("/" + lang + "/" + params.center);
            }}
          >
            <option value="en">
              English(US)
          ...
          <div className="w-full flex flex-col sm:flex-row gap-5 items-start justify-start">
                          ...
                          <div className="flex flex-col gap-2 justify-center items-center">
                            ...
                            {address && (
                              <span className="text-sm text-red-500">
                                회원 아이디가 설정되지 않았습니다.<br/>
                                거래를 시작하려면 회원 아이디를 설정해야 합니다.
                              </span>
                            )}
